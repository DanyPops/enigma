...
export const MASTER_KEY_PROVIDER_FILENAME = "master-key.json";
export const CLIENT_REGISTRY_FILENAME = "clients.json";

/** Stable native-store lookup attributes let legacy and current adapters resolve the same entry. */
