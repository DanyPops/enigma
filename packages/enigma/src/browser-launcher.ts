 ...
 * `xdg-open` elsewhere) -- matches GitHub CLI's own device-flow pattern
 * (`internal/authflow/flow.go`): always show the URL as text regardless, and
 * treat opening a real browser as a convenience that can fail (headless
